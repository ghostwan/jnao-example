...
public class ALAudioRecorder extends ALModule {
    ...
    /**
     * 113 startMicrophonesRecording Void (String,String,Int32,Value)
     ...
     * filename: Name of the file where to record the sound.
     * type: wav or ogg.
     * samplerate: Required sample rate.
     * channels: vector of booleans.
     */
    public void startMicrophonesRecording(String param1, String param2, Integer param3, com.aldebaran.qimessaging.Object param4) throws CallError, InterruptedException {
        if (isAsynchronous)
            service.call("startMicrophonesRecording", param1, param2, param3, param4);
        else
            service.call("startMicrophonesRecording", param1, param2, param3, param4).get();
    }

    /**
     * 114 stopMicrophonesRecording  Void ()
