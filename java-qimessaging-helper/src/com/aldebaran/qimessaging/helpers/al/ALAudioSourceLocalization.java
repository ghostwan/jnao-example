 ...
 */
public class ALAudioSourceLocalization extends ALModule {
     ...
     * parameter: Name of the parameter. "Sensibility" between 0 and 1 to adjust the capacity of NAO to locate quiet sounds. "EnergyComputation" (1 or 0) that activates the computation of the located source signal energy. This energy is added in the "ALSoundLocalization/SoundLocated" ALMemory key.
     * value: "Sensibility" : a float in [0,1]. "EnergyComputation" : (1 or 0).
     * * Signals:
     */
