 ...
 */
public class ALAutomaticVolume extends ALModule {

    public ALAutomaticVolume(Session session) {
        super(session);
    }
    ...
    /**
     * 129 enableVolumeAdaptation Void (Bool)
     * This method will start the adaptation of the speaker volume from the background noise.
     * * Signals:
     */
    public void enableVolumeAdaptation(Boolean param1) throws CallError, InterruptedException {
        if (isAsynchronous)
            service.call("enableVolumeAdaptation", param1);
        else
            service.call("enableVolumeAdaptation", param1).get();
    }
