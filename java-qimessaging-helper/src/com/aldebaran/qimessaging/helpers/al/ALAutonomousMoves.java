...
public class ALAutonomousMoves extends ALModule {
    ...
    /**
     * 113 startSmallDisplacements       Void ()
    ...
    /**
     * 114 stopSmallDisplacements        Void ()
    ...
    /**
     * 119 setExpressiveListeningEnabled Void (Bool)
     * Enable or disable expressive listening.
     * enable: The boolean value: true to enable, false to disable.
     */
    public void setExpressiveListeningEnabled(Boolean param1) throws CallError, InterruptedException {
        if (isAsynchronous)
            service.call("setExpressiveListeningEnabled", param1);
        else
            service.call("setExpressiveListeningEnabled", param1).get();
    }

    /**
     * 121 getExpressiveListeningEnabled Bool ()
