...
public class ALBattery extends ALModule {
    ...
    /**
     * 113 enablePowerMonitoring Void (Bool)
     * Enable power monitoring
     * Enable: True activate power monitoring
     */
    public void enablePowerMonitoring(Boolean param1) throws CallError, InterruptedException {
        if (isAsynchronous)
            service.call("enablePowerMonitoring", param1);
        else
            service.call("enablePowerMonitoring", param1).get();
    }

    /**
     * 114 getBatteryCharge      Int32 ()
