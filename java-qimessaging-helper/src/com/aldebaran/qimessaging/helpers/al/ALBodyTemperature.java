...
public class ALBodyTemperature extends ALModule {
    ...
    /**
     * 113 getTemperatureDiagnosis Value ()
     * The actual state of the temperature diagnosis.
     * return: Return the current temperature diagnosis.
     */
    public com.aldebaran.qimessaging.Object getTemperatureDiagnosis() throws CallError, InterruptedException {
        return (com.aldebaran.qimessaging.Object) service.call("getTemperatureDiagnosis").get();
    }

    /**
     * 114 setEnableNotifications  Void (Bool)
     * Enables / Disables temperature notifications.
     * enable: If True enable temperature notifications. If False disable temperature notifications.
     */
    ...
    /**
     * 115 areNotificationsEnabled Bool ()
