 ...
 */
public class ALDarknessDetection extends ALModule {

    public ALDarknessDetection(Session session) {
        super(session);
    }
    ...
    /**
     * 138 setDarknessThreshold Void (Int32)
     * Enables to change the DarknessThreshold for isItDark
     * threshold: New darkness threshold (between 0 and 100)
     */
    public void setDarknessThreshold(Integer param1) throws CallError, InterruptedException {
        if (isAsynchronous)
            service.call("setDarknessThreshold", param1);
        else
            service.call("setDarknessThreshold", param1).get();
    }

    /**
     * 139 getDarknessThreshold Int32 ()
    ...
    public Integer getDarknessThreshold() throws CallError, InterruptedException {
        return (Integer) service.call("getDarknessThreshold").get();
    }
