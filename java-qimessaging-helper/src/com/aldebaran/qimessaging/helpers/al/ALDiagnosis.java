...
public class ALDiagnosis extends ALModule {
    ...
    /**
     * 113 getPassiveDiagnosis   Value ()
     * The actual state of the passive diagnosis.
     */
    public com.aldebaran.qimessaging.Object getPassiveDiagnosis() throws CallError, InterruptedException {
        return (com.aldebaran.qimessaging.Object) service.call("getPassiveDiagnosis").get();
    }

    /**
     * 114 getActiveDiagnosis    Value ()
     * The actual state of the active diagnosis.
     */
    public com.aldebaran.qimessaging.Object getActiveDiagnosis() throws CallError, InterruptedException {
        return (com.aldebaran.qimessaging.Object) service.call("getActiveDiagnosis").get();
    }

    /**
     * 115 setEnableNotification Void (Bool)
     * Enable / Disable diagnosis notification.
     * enable: If True enable diagnosis notification. If False disable diagnosis notification.
     */
    public void setEnableNotification(Boolean param1) throws CallError, InterruptedException {
        if (isAsynchronous)
            service.call("setEnableNotification", param1);
        else
            service.call("setEnableNotification", param1).get();
    }

    /**
     * 116 isNotificationEnabled Bool ()
