 ...
 */
public class ALFaceCharacteristics extends ALModule {

    public ALFaceCharacteristics(Session session) {
        super(session);
    }
    ...
    /**
     * 129 analyzeFaceCharacteristics Bool (Int32)
     * Runs face analysis for a given person ID.
     * id: Person ID.
     * return: True if the face analysis succeeded, false otherwise.
     */
    public Boolean analyzeFaceCharacteristics(Integer param1) throws CallError, InterruptedException {
        return (Boolean) service.call("analyzeFaceCharacteristics", param1).get();
    }

    /**
     * 130 setSmilingThreshold        Void (Float)
     * Sets the smile degree threshold above which an event is raised.
     * threshold: New threshold (must be between 0.0 and 1.0.
     */
    public void setSmilingThreshold(Float param1) throws CallError, InterruptedException {
        if (isAsynchronous)
            service.call("setSmilingThreshold", param1);
        else
            service.call("setSmilingThreshold", param1).get();
    }

    /**
     * 131 getSmilingThreshold        Float ()
    ...
    public Float getSmilingThreshold() throws CallError, InterruptedException {
        return (Float) service.call("getSmilingThreshold").get();
    }
