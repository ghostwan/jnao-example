...
public class ALFaceDetection extends ALModule {
    ...
    /**
     * 138 setDetectionMode       Void (Int32)
     ...
     */
    public void setDetectionMode(Integer param1) throws CallError, InterruptedException {
        if (isAsynchronous)
            service.call("setDetectionMode", param1);
        else
            service.call("setDetectionMode", param1).get();
    }

    /**
     * 139 getDetectionMode       Int32 ()
     * Returns the current mode of detection
     * return: current mode of deteciton (0, 1, 2 or 3)
     */
    public Integer getDetectionMode() throws CallError, InterruptedException {
        return (Integer) service.call("getDetectionMode").get();
    }

    /**
     * 140 isFaceAnalysisEnabled  Bool ()
    ...
    /**
     * 141 setFaceAnalysisEnabled Void (Bool)
     * Enables or disables the full face analysis
     * enabled: True to enable, False to disable
     */
    public void setFaceAnalysisEnabled(Boolean param1) throws CallError, InterruptedException {
        if (isAsynchronous)
            service.call("setFaceAnalysisEnabled", param1);
        else
            service.call("setFaceAnalysisEnabled", param1).get();
    }

    /**
     * 142 importOldDatabase      Bool (String)
     ...
     */
    public Boolean importOldDatabase(String param1) throws CallError, InterruptedException {
        return (Boolean) service.call("importOldDatabase", param1).get();
    }

    /**
     * 143 enableRecognition      Void (Bool)
     * deprecated
     */
    ...
    /**
     * 144 setRecognitionEnabled  Void (Bool)
     * enable/disable the recognition stageProcess will be faster when disabled when you don't need to recognize people
     * enable: True/False
     */
    public void setRecognitionEnabled(Boolean param1) throws CallError, InterruptedException {
        if (isAsynchronous)
            service.call("setRecognitionEnabled", param1);
        else
            service.call("setRecognitionEnabled", param1).get();
    }

    /**
     * 145 isRecognitionEnabled   Bool ()
    ...
    /**
     * 147 setTrackingEnabled     Void (Bool)
     ...
     * enable: True/False
     */
    public void setTrackingEnabled(Boolean param1) throws CallError, InterruptedException {
        if (isAsynchronous)
            service.call("setTrackingEnabled", param1);
        else
            service.call("setTrackingEnabled", param1).get();
    }

    /**
     * 148 isTrackingEnabled      Bool ()
    ...
    /**
     * 149 learnFace              Bool (String)
     * Add a new face in the database.
     * pId: The name of the person to save
     * return: true if the operation succeeds
     */
    public Boolean learnFace(String param1) throws CallError, InterruptedException {
        return (Boolean) service.call("learnFace", param1).get();
    }

    /**
     * 150 reLearnFace            Bool (String)
     * use in a new learning process the latest images where a face has been wrongly recognized
     * pId: The name of the person to save
     * return: true if the operation succeeds
     */
    public Boolean reLearnFace(String param1) throws CallError, InterruptedException {
        return (Boolean) service.call("reLearnFace", param1).get();
    }

    /**
     * 151 forgetPerson           Bool (String)
     * Delete from the database all faces instances of a person.
     * pId: The name of the person to forget
     * return: true if the operation succeeds
     */
    public Boolean forgetPerson(String param1) throws CallError, InterruptedException {
        return (Boolean) service.call("forgetPerson", param1).get();
    }

    /**
     * 152 clearDatabase          Bool ()
