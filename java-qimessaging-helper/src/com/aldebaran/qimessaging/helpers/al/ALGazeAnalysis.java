 ...
 */
public class ALGazeAnalysis extends ALModule {

    public ALGazeAnalysis(Session session) {
        super(session);
    }
    ...
    /**
     * 129 setFaceAnalysisEnabled Void (Bool)
    ...
    /**
     * 130 isFaceAnalysisEnabled  Bool ()
     ...
     * tolerance: New value of the tolerance (between 0 and 1).
     */
    public void setTolerance(Float param1) throws CallError, InterruptedException {
        if (isAsynchronous)
            service.call("setTolerance", param1);
        else
            service.call("setTolerance", param1).get();
    }

    /**
     * 132 getTolerance           Float ()
