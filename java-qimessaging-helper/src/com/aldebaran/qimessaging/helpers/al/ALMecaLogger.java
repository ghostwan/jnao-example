 ...
 */
public class ALMecaLogger extends ALModule {

    public ALMecaLogger(Session session) {
        super(session);
    }
     ...
     */
    public void writeFiles() throws CallError, InterruptedException {
        if (isAsynchronous)
            service.call("writeFiles");
        else
            service.call("writeFiles").get();
    }

    /**
     * 114 toDoWhenRobotHasFallen Void (String,Value,Value)
     * Increment the number of falls
     * * Signals:
     */
    public void toDoWhenRobotHasFallen(String param1, com.aldebaran.qimessaging.Object param2, com.aldebaran.qimessaging.Object param3) throws CallError, InterruptedException {
        if (isAsynchronous)
            service.call("toDoWhenRobotHasFallen", param1, param2, param3);
        else
            service.call("toDoWhenRobotHasFallen", param1, param2, param3).get();
    }
