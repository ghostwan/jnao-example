 ...
 */
public class ALMovementDetection extends ALModule {

    public ALMovementDetection(Session session) {
        super(session);
    }
    ...
    /**
     * 133 setActiveCamera     Bool (Int32)
    ...
    /**
     * 135 resetDetection      Void ()
     * Enables to reset the movement detection when desired
     */
    public void resetDetection() throws CallError, InterruptedException {
        if (isAsynchronous)
            service.call("resetDetection");
        else
            service.call("resetDetection").get();
    }

    /**
     * 136 setColorSensitivity Void (Float)
     * Sets the value of the color sensitivity used for the 2D detection  of moving pixels in the image.
     * sensitivity: New color sensitivity (between 0 and 1)
     */
    public void setColorSensitivity(Float param1) throws CallError, InterruptedException {
        if (isAsynchronous)
            service.call("setColorSensitivity", param1);
        else
            service.call("setColorSensitivity", param1).get();
    }

    /**
     * 137 getColorSensitivity Float ()
    ...
    public Float getColorSensitivity() throws CallError, InterruptedException {
        return (Float) service.call("getColorSensitivity").get();
    }

    /**
     * 138 setDepthSensitivity Void (Float)
     * Sets the value of the depth sensitivity (in meters) used for the detection 3D of moving pixels in the image.
     * sensitivity: New depth sensitivity (in meters)
     */
    public void setDepthSensitivity(Float param1) throws CallError, InterruptedException {
        if (isAsynchronous)
            service.call("setDepthSensitivity", param1);
        else
            service.call("setDepthSensitivity", param1).get();
    }

    /**
     * 139 getDepthSensitivity Float ()
     * gets the value of the depth sensitivity (in meters)
     * return: Current depth sensitivity (in meters)
     * * Signals:
     */
    public Float getDepthSensitivity() throws CallError, InterruptedException {
        return (Float) service.call("getDepthSensitivity").get();
    }
