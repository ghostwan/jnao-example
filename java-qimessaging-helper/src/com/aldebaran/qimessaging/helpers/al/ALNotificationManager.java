 ...
 */
public class ALNotificationManager extends ALModule {

    public ALNotificationManager(Session session) {
        super(session);
    }
     ...
     * 113 add           Int32 (Value)
     * Add a notification.
     * notification: Contain information for the notification
     * return: Notification ID.
     */
    public Integer add(com.aldebaran.qimessaging.Object param1) throws CallError, InterruptedException {
        return (Integer) service.call("add", param1).get();
    }

    /**
     * 114 remove        Void (Int32)
     * Remove a notification.
     * notificationId: Notification ID to remove.
     */
    public void remove(Integer param1) throws CallError, InterruptedException {
        if (isAsynchronous)
            service.call("remove", param1);
        else
            service.call("remove", param1).get();
    }

    /**
     * 115 notifications Value ()
     * Get the all array of pending notifications.
     * return: An array of pending notification.
     */
    public com.aldebaran.qimessaging.Object notifications() throws CallError, InterruptedException {
        return (com.aldebaran.qimessaging.Object) service.call("notifications").get();
    }

    /**
     * 116 notification  Value (Int32)
     * Get one notification.
     * notificationId: Notification ID.
     * return: ALValue containing a Notification.
     * * Signals:
     */
    public com.aldebaran.qimessaging.Object notification(Integer param1) throws CallError, InterruptedException {
        return (com.aldebaran.qimessaging.Object) service.call("notification", param1).get();
    }
