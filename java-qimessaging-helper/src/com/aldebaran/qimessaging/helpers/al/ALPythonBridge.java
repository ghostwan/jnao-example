 ...
 */
public class ALPythonBridge extends ALModule {

    public ALPythonBridge(Session session) {
        super(session);
    }
    ...
    /**
     * 113 eval          String (String)
     * eval script
     * stringToEvaluate: string to eval
     * return: if the evaluation has gone wrong
     */
    public String eval(String param1) throws CallError, InterruptedException {
        return (String) service.call("eval", param1).get();
    }

    /**
     * 114 evalReturn    Value (String)
     * eval script and return result. evalReturn(2+2) will return 4
     * stringToEvaluate: string to eval
     * return: the result of the evaluation
     */
    public com.aldebaran.qimessaging.Object evalReturn(String param1) throws CallError, InterruptedException {
        return (com.aldebaran.qimessaging.Object) service.call("evalReturn", param1).get();
    }

    /**
     * 115 evalFull      Value (String)
     * evaluates script and returns an informative array.
     * stringToEvaluate: string to eval
     * return: an array containing [return value, exceptions, stdout, stderr]
     * * Signals:
     */
    public com.aldebaran.qimessaging.Object evalFull(String param1) throws CallError, InterruptedException {
        return (com.aldebaran.qimessaging.Object) service.call("evalFull", param1).get();
    }
