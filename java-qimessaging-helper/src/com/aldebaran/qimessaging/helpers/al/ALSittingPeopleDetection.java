 ...
 */
public class ALSittingPeopleDetection extends ALModule {

    public ALSittingPeopleDetection(Session session) {
        super(session);
    }
    ...
    /**
     * 129 setSittingThreshold Void (Float)
     * Sets sitting threshold
     * threshold: float, face height (in meter) from the ground under which we consider thatsomeone is sitting.
     */
    public void setSittingThreshold(Float param1) throws CallError, InterruptedException {
        if (isAsynchronous)
            service.call("setSittingThreshold", param1);
        else
            service.call("setSittingThreshold", param1).get();
    }

    /**
     * 130 getSittingThreshold Float ()
     * Gets sitting threshold
     * return: Maximum face height in meter
     * * Signals:
     */
    public Float getSittingThreshold() throws CallError, InterruptedException {
        return (Float) service.call("getSittingThreshold").get();
    }
