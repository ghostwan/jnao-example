...
public class ALVisionRecognition extends ALModule {
    ...
    /**
     * 138 changeDatabase      Bool (String,String)
     ...
     */
    public Boolean changeDatabase(String param1, String param2) throws CallError, InterruptedException {
        return (Boolean) service.call("changeDatabase", param1, param2).get();
    }

    /**
     * 139 setParam            Void (String,Value)
     * Set vision recognition parameters (deprecated in 1.22)
     * paramName: Name of the parameter to be changed. Only "resolution" can be used.
     * paramValue: Value of the resolution as an integer: 0(QQVGA) 1(QVGA) 2(VGA)
     */
    public void setParam(String param1, com.aldebaran.qimessaging.Object param2) throws CallError, InterruptedException {
        if (isAsynchronous)
    ...
    /**
     * 140 getParam            Value (String)
     * Get some vision recognition parameters.
     * paramName: The name of the parameter to get. "db_path" and "db_name" can be used.
     * return: Value of the parameter as a string for "db_path" and "db_name"
     * * Signals:
     */
    public com.aldebaran.qimessaging.Object getParam(String param1) throws CallError, InterruptedException {
        return (com.aldebaran.qimessaging.Object) service.call("getParam", param1).get();
    }
